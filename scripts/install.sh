...
download_model() {
    ...
    echo -e "  ${GREEN}1)${NC} CodeLlama (7B)         - Recommended, ~4GB RAM"
    echo -e "  ${GREEN}2)${NC} DeepSeek Coder (6.7B) - Excellent for code, ~4GB RAM"
    echo -e "  ${GREEN}3)${NC} Phind CodeLlama (34B) - Best quality, ~20GB RAM"
    echo -e "  ${GREEN}4)${NC} Mistral (7B)          - General purpose, ~4GB RAM"
    echo -e "  ${GREEN}5)${NC} Skip for now          - Download manually later"
    echo ""
...
print_summary() {
    ...
    echo "     or"
    echo -e "     ${CYAN}python3 src/server.py${NC}"
    echo ""
    ...
    echo -e "  Download model:  ${CYAN}ollama pull <model-name>${NC}"
    echo -e "  Remove model:    ${CYAN}ollama rm <model-name>${NC}"
    echo -e "  Stop Ollama:     ${CYAN}pkill ollama${NC}"
    echo ""
